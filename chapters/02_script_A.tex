...
For more details regarding the JSON interface, its features and detailed usage, visit the local URL \url{http://localhost:5000/ipm/help/jsoniface_help} after launching \texttt{JSONServer}, which is provided by Fraunhofer IPM.

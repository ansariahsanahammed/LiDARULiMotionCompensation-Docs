...
The script applies the initial rotation angles, pauses for a keypress, then enters an infinite loop iterating through the angle increment range. The loop restarts when the range is done. Press \texttt{Ctrl+C} to stop the loop.
